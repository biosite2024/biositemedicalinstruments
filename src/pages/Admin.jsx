...
export default function Admin() {
  return (
    <>
      {/* Page content begins here. You should remove the  and , ,  tags in JSX */}
      {/* Use Helmet for head elements if needed */}
                  ...
                  <div className="slide-track">
                    {[...Array(2)].flatMap(() => (
                      [10,11,12,13,14,15,3,4,5,6,7,8,9].map(num => (
                        <div key={num + Math.random()} className="slide">
                          <img src={`/img/headlogo/${num}.png`} height="100" width="150" alt="logo" />
                        </div>
                      ))
                    ))}
                  </div>
      ...
      <section className="pf-details section">
        <div className="container">
          <div className="row">
            <div className="col-12">
              {/* The table content was omitted here for brevity */}
              <p>[Table of Forms goes here]</p>
            </div>
          </div>
        </div>
      </section>
